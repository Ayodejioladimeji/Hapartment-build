...
const UpdateProperty = ({ route, navigation }) => {
  ...
  const { listing_callback, isEdit, updateId } = useSelector(
    (state) => state.listing
  );
          ...
          <View style={styles.identityWrapper}>
            ...
            <View style={styles.section}>
              <TouchableOpacity
                ...
                onPress={() =>
                  navigation.navigate("BasicInformation", { item })
                }
              >
            ...
            <TouchableOpacity activeOpacity={0.7} onPress={userNavigation}>
              <View style={styles.identityBtn}>
                <Text style={styles.identityBtnText}>Go Back</Text>
              </View>
            </TouchableOpacity>
            ...
            >
              {createlistingloading ? (
                ...
                <Text style={styles.identityButtonText}>UPDATE LISTING</Text>
              )}
            </TouchableOpacity>
          </View>
        </View>
